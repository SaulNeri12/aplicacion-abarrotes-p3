...
public class ConsultasAbarrotes {
    ...
    // productos empacados
    public static String PRODUCTOS_EMPACADOS_POR_NOMBRE = "SELECT * FROM ProductosEmpacados WHERE nombre = '%s'";
    public static String PRODUCTOS_EMPACADOS_POR_CLAVE  = "SELECT * FROM ProductosEmpacados WHERE clave_producto = '%s'";
    // productos granel
